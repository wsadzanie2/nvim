...
keymap.set("n", "<leader>sp", "<C-w>s") -- split window horizontally
...
keymap.set("n", "<leader>eh", ":NvimTreeResize -5<CR>") -- find file in file explorer
keymap.set("n", "<leader>el", ":NvimTreeResize +5<CR>") -- find file in file explorer
...
-- transparency and color highlighting
keymap.set("n", '<leader>mm', '<cmd>TransparentToggle<cr>')
keymap.set("n", '<leader>mn', '<cmd>HighlightColors Toggle<cr>')
